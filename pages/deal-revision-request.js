...
const DealRevisionRequest = () => {
    return (
    <section className='lending__limit__sec__wrap prdLR30'>
        <BreadCrumb subtitle='Liquidity Module /' subtitle1='Dealing /' subtitle2='Deal Revision Request' title='Deal Revision Request' />
...
export default DealRevisionRequest;
